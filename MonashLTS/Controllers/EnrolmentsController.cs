...
namespace MonashLTS.Controllers
{
    public class EnrolmentsController : Controller
    {
        ...
        {
            var enrolments = db.Enrolments.Include(e => e.Student).Include(e => e.Unit);
        ...
        {
            ViewBag.student_id = new SelectList(db.Students, "id", "CourseTitle");
            ViewBag.StuUnit_id = new SelectList(db.Units, "id", "UnitCode");
            return View();
        }
